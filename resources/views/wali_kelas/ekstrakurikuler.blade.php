                    ...
                    <tr class="bg-white border-b hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex justify-center gap-2">
                                <a href="{{ route('wali_kelas.ekstrakurikuler.edit', $nilai->id) }}" class="text-yellow-600 hover:text-yellow-800">
                                    <img src="{{ asset('images/icons/edit.png') }}" alt="Edit Icon" class="w-5 h-5">
                                </a>
                                <form action="{{ route('wali_kelas.ekstrakurikuler.destroy', $nilai->id) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
