            ...
            <table class="w-full text-sm text-left text-gray-500">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">Ahmad Rifai</td>
                        <td class="px-6 py-4">7A</td>
                        <td class="px-6 py-4">2010-05-15</td>
                        <td class="px-6 py-4">Laki-laki</td>
                        <td class="px-6 py-4">Islam</td>
                        <td class="px-6 py-4">Jl. Pendidikan No. 123</td>
                        <td class="px-6 py-4">
                            <div class="flex gap-2">
                                <a href="{{ route('wali_kelas.student.show', 1) }}" 
                                ...
                                <form action="{{ route('wali_kelas.student.destroy', 1) }}" method="POST" 
                                    class="inline-block">
                                    @csrf
                                    @method('DELETE')
                    ...
                    <tr class="bg-white border-b hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">20230002</td>
                        <td class="px-6 py-4">1234567891</td>
                        <td class="px-6 py-4">Siti Nurhaliza</td>
                        <td class="px-6 py-4">7A</td>
                        <td class="px-6 py-4">2010-08-20</td>
                        <td class="px-6 py-4">Perempuan</td>
                        <td class="px-6 py-4">Islam</td>
                        <td class="px-6 py-4">Jl. Pendidikan No. 124</td>
                        <td class="px-6 py-4">
                            <div class="flex gap-2">
                                <a href="{{ route('wali_kelas.student.show', 2) }}" 
                                    class="text-blue-600 hover:text-blue-900">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                ...
                                <a href="{{ route('wali_kelas.student.edit', 2) }}" 
                                    class="text-yellow-600 hover:text-yellow-900">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                    </svg>
                                </a>
                                <form action="{{ route('wali_kelas.student.destroy', 2) }}" method="POST" 
                                    class="inline-block">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="text-red-600 hover:text-red-900" 
