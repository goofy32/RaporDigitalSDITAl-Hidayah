...
<div class="p-4 bg-white mt-14 rounded-lg">
    ...
    <form action="{{ route('kkm.update', $mataPelajaran->id) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-end space-x-3">
            <a href="{{ route('subject.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                Batal
            </a>
