    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 bg-white mt-14">
            ...
            <div class="flex justify-start mb-4">
                <a href="{{ route('student.create') }}" class="flex items-center justify-center text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2">
            ...
            <form class="max-w-sm mb-6">
                <label for="kelas" class="text-sm font-bold text-gray-900 dark:text-white">Silahkan pilih kelas dibawah</label>
                <select id="kelas"
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-center flex justify-around">
                                <a href="{{ route('student.show', $student['id']) }}" class="text-blue-600 hover:underline">
